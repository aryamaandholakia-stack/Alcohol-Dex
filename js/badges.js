...
const BADGES = [
  ...
  { id: "complete",  icon: "💎", name: "The Full Cellar",desc: "Log every bottle in the Dex",                test: s => s.total >= s.catalogTotal },
  ...
  { id: "leg20",     icon: "🔱", name: "The Pantheon",   desc: "Discover every legendary",           test: s => s.legendaries >= s.legTotal }
];
